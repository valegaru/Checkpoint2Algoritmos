...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.css */ \"./src/index.css\");\n/* harmony import */ var _components_export__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/export */ \"./src/components/export.ts\");\n/* harmony import */ var _services_getDataImage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/getDataImage */ \"./src/services/getDataImage.ts\");\n/* harmony import */ var _services_getDataText__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/getDataText */ \"./src/services/getDataText.ts\");\n/* harmony import */ var _components_Card_card__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/Card/card */ \"./src/components/Card/card.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\n\n\n\n\n\nclass AppContainer extends HTMLElement {\n    constructor() {\n        super();\n        this.attachShadow({ mode: \"open\" });\n    }\n    connectedCallback() {\n        return __awaiter(this, void 0, void 0, function* () {\n            const datatext = yield (0,_services_getDataText__WEBPACK_IMPORTED_MODULE_3__.getDataText)();\n            console.log(datatext);\n            const firstwords = datatext.split(\" \", 4);\n            console.log(firstwords);\n            const joinedwords = firstwords.join(\" \");\n            console.log(joinedwords);\n            const dataimage = yield (0,_services_getDataImage__WEBPACK_IMPORTED_MODULE_2__.getDataImage)(joinedwords);\n            console.log(dataimage);\n            this.render(dataimage, datatext);\n        });\n    }\n    render(dataimage, datatext) {\n        var _a, _b;\n        if (this.shadowRoot)\n            this.shadowRoot.innerHTML = ``;\n        const card = this.ownerDocument.createElement('my-card');\n        card.setAttribute(_components_Card_card__WEBPACK_IMPORTED_MODULE_4__.AttributeCard.image, dataimage);\n        card.setAttribute(_components_Card_card__WEBPACK_IMPORTED_MODULE_4__.AttributeCard.text, datatext);\n        (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.appendChild(card);\n        const cssAbuelo = this.ownerDocument.createElement('style');\n        cssAbuelo.innerHTML = _index_css__WEBPACK_IMPORTED_MODULE_0__[\"default\"];\n        (_b = this.shadowRoot) === null || _b === void 0 ? void 0 : _b.appendChild(cssAbuelo);\n    }\n}\ncustomElements.define('app-container', AppContainer);\n//dataimage.forEach((e:any) => {\n\n\n//# sourceURL=webpack://dca_scoffolding/./src/index.ts?");

/***/ }),

/***/ "./src/services/getDataImage.ts":
/*!**************************************!*\
  !*** ./src/services/getDataImage.ts ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getDataImage\": () => (/* binding */ getDataImage)\n/* harmony export */ });\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nfunction getDataImage(joinedwords) {\n    return __awaiter(this, void 0, void 0, function* () {\n        try {\n            const data = yield fetch('https://cataas.com/cat/says/' + joinedwords).then(res => res.url);\n            console.log(data);\n            return data;\n        }\n        catch (error) {\n            console.error(error);\n        }\n    });\n}\n\n\n//# sourceURL=webpack://dca_scoffolding/./src/services/getDataImage.ts?");

/***/ }),

/***/ "./src/services/getDataText.ts":
/*!*************************************!*\
  !*** ./src/services/getDataText.ts ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getDataText\": () => (/* binding */ getDataText)\n/* harmony export */ });\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nfunction getDataText() {\n    return __awaiter(this, void 0, void 0, function* () {\n        try {\n            const data = yield fetch('https://catfact.ninja/fact').then(res => res.json());\n            console.log(data);\n            return data.fact;\n        }\n        catch (error) {\n            console.error(error);\n        }\n    });\n}\n\n\n//# sourceURL=webpack://dca_scoffolding/./src/services/getDataText.ts?");
